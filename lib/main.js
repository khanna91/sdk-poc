...
eval("var CONFIG = __webpack_require__(/*! ./config */ \"./src/config.js\");\n\nvar API = function API(global, $, partnerKey) {\n  var getProfile = function getProfile(sessionState, nonce) {\n    return new Promise(function (resolve, reject) {\n      $.ajax({\n        url: \"\".concat(CONFIG.API.DOMAIN).concat(CONFIG.API.VERSION).concat(CONFIG.API.PROFILE),\n        headers: {\n          'session-state': sessionState,\n          'client-id': partnerKey,\n          nonce: nonce\n        }\n      }).then(function (data) {\n        resolve(data.response);\n      }).catch(function (err) {\n        reject(new Error(err));\n      });\n    });\n  };\n\n  var logout = function logout(sessionState, nonce) {\n    return new Promise(function (resolve, reject) {\n      $.ajax({\n        url: \"\".concat(CONFIG.API.DOMAIN).concat(CONFIG.API.VERSION).concat(CONFIG.API.LOGOUT),\n        method: 'DELETE',\n        headers: {\n          'session-state': sessionState,\n          'client-id': partnerKey,\n          nonce: nonce\n        }\n      }).then(function (data) {\n        resolve(data.response);\n      }).catch(function (err) {\n        reject(new Error(err));\n      });\n    });\n  };\n\n  return {\n    getProfile: getProfile,\n    logout: logout\n  };\n};\n\nmodule.exports = API;\n\n//# sourceURL=webpack:///./src/api.js?");
...
eval("var SSO = __webpack_require__(/*! ./sso */ \"./src/sso.js\");\n\n;\n\n(function (global, $) {\n  var script_tag = document.getElementById('astro-identity');\n  var query = script_tag.src.replace(/^[^\\?]+\\??/, ''); // Parse the querystring into arguments and parameters\n\n  var vars = query.split(\"&\");\n  var args = {};\n\n  for (var i = 0; i < vars.length; i++) {\n    var pair = vars[i].split(\"=\"); // decodeURI doesn't expand \"+\" to a space.\n\n    args[pair[0]] = decodeURI(pair[1]).replace(/\\+/g, ' ');\n  }\n\n  var partnerKey = args['partnerKey'];\n  global.sso = new SSO(global, $, partnerKey);\n})(window, $);\n\n//# sourceURL=webpack:///./src/index.js?");
...
eval("var SSO = function SSO(global, $, partnerKey) {\n  var CONFIG = __webpack_require__(/*! ./config */ \"./src/config.js\");\n\n  var Utils = __webpack_require__(/*! ./utils */ \"./src/utils.js\")(global);\n\n  var API = __webpack_require__(/*! ./api */ \"./src/api.js\")(global, $, partnerKey);\n\n  var User = __webpack_require__(/*! ./user */ \"./src/user.js\")();\n\n  var authenticate = function authenticate(queryParams) {\n    var astroIdentitySessionState = Utils.getQueryStringValue('session_state') || Utils.getCookie(CONFIG.COOKIE.SESSION); // Astro Identity Session State\n\n    var astroNonce = Utils.getQueryStringValue('nonce') || Utils.getCookie(CONFIG.COOKIE.NONCE); // Astro Identity Nonce\n\n    if (astroIdentitySessionState) {\n      // need to get user profile\n      Utils.setCookie(CONFIG.COOKIE.SESSION, astroIdentitySessionState);\n\n      if (!astroNonce) {\n        astroNonce = Utils.generateNonce();\n      }\n\n      Utils.setCookie(CONFIG.COOKIE.NONCE, astroNonce);\n      API.getProfile(astroIdentitySessionState, astroNonce).then(function (user) {\n        User.setUser(user);\n        global.dispatchEvent(new CustomEvent(\"authStatusChange\"));\n      }).catch(function (err) {\n        User.setUser(null);\n        global.dispatchEvent(new CustomEvent(\"authStatusChange\"));\n      });\n    } else if (!astroNonce) {\n      // need to redirect to identity portal to check user auth state\n      queryString = Utils.makeQueryString(queryParams);\n      global.location.href = \"\".concat(CONFIG.PORTAL.DOMAIN, \"/auth?\").concat(queryString);\n    } // otherwise, user never logged in, dont do anything\n\n  };\n\n  var login = function login(params) {\n    if (!params.partnerKey || !params.redirect_uri || !params.continue) {\n      console.error('Missing Identity Parameters');\n      return;\n    }\n\n    params.response_type = 'code';\n    params.scope = 'openid';\n    params.nonce = Utils.generateNonce();\n    params.state = '321';\n    params.redirectToLogin = true;\n    queryString = Utils.makeQueryString(params);\n    global.location.href = \"\".concat(CONFIG.PORTAL.DOMAIN, \"/auth?\").concat(queryString);\n  };\n\n  var register = function register(params) {\n    if (!params.partnerKey || !params.redirect_uri) {\n      console.error('Missing Identity Parameters');\n      return;\n    }\n\n    params.response_type = 'code';\n    params.scope = 'openid';\n    params.nonce = Utils.generateNonce();\n    params.state = '321';\n    queryString = Utils.makeQueryString(params);\n    global.location.href = \"\".concat(CONFIG.PORTAL.DOMAIN, \"/register?\").concat(queryString);\n  };\n\n  var getCurrentUser = function getCurrentUser() {\n    return User.getUser();\n  };\n\n  var logout = function logout(params) {\n    var sessionState = Utils.getCookie(CONFIG.COOKIE.SESSION);\n    var nonce = Utils.getCookie(CONFIG.COOKIE.NONCE);\n    API.logout(sessionState, nonce).then(function (user) {\n      User.setUser(null);\n      global.dispatchEvent(new CustomEvent(\"authStatusChange\"));\n      Utils.deleteCookie(CONFIG.COOKIE.SESSION);\n      queryString = Utils.makeQueryString(params);\n      window.location.href = \"\".concat(CONFIG.PORTAL.DOMAIN, \"/logout?\").concat(queryString);\n    }).catch(function (err) {\n      console.error(err);\n    });\n  };\n\n  return {\n    authenticate: authenticate,\n    login: login,\n    register: register,\n    getCurrentUser: getCurrentUser,\n    logout: logout\n  };\n};\n\nmodule.exports = SSO;\n\n//# sourceURL=webpack:///./src/sso.js?");
...
eval("var User = function User() {\n  var user = null;\n\n  var getUser = function getUser() {\n    return user;\n  };\n\n  var setUser = function setUser(identity) {\n    user = identity;\n  };\n\n  return {\n    getUser: getUser,\n    setUser: setUser\n  };\n};\n\nmodule.exports = User;\n\n//# sourceURL=webpack:///./src/user.js?");
